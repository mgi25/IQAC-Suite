        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="When true, this event's CDL work is considered completed and shown under Analysis",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "committees",
                    models.TextField(
                        blank=True, help_text="List of committees involved."
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Latest review feedback for current session",
                    ),
                ),
                (
                    "review_stage",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Display label for custom tasks",
                        max_length=200,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="cdl_task_assignments",
                        to="emt.eventproposal",
                    ),
                ),
            ],
            options={
                "indexes": [
                    models.Index(
                        fields=["assignee"], name="emt_cdltask_assigne_9e354d_idx"
                    ),
                    models.Index(
                        fields=["proposal", "resource_key"],
                        name="emt_cdltask_proposa_e4388f_idx",
                    ),
                ],
