...
def test_cdl_communication_create_and_list(client):
    ...
    uploaded = SimpleUploadedFile('note.txt', b'Attachment content', content_type='text/plain')
    ...
    assert comments[0] in ('With file', 'Hello world')  # Ordering by created_at desc, but creation may be fast
