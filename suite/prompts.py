...
Measurable wording without making up numeric targets unless they are in facts.
Unknowns -> [TBD]."""
SYSTEM_LEARNING = """Use ONLY provided facts. 3-5 bullets; Bloom-style verbs
(explain, apply, analyse, evaluate, create, reflect).
